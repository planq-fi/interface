...
const EXTERNAL_APIS = [
  {
    name: 'Auto Router',
    description: <Trans>The app fetches the optimal trade route from a PlanqFi server.</Trans>,
  },
  {
    name: 'Infura',
    ...
    >
      <AutoColumn gap="16px">
        <AutoColumn gap="sm" style={{ width: '100%' }}>
              ...
              <RowBetween>
                <AutoRow gap="4px">
                  ...
                  <ThemedText.DeprecatedMain fontSize={14} color="deprecated_primaryText1">
                    <Trans>PlanqFi&apos; Terms of Service</Trans>
          ...
          <StyledExternalCard>
            <ExternalLink href="https://planq.network/privacy-policy/">
              <RowBetween>
                <AutoRow gap="4px">
                  <Info size={20} />
                  <ThemedText.DeprecatedMain fontSize={14} color="deprecated_primaryText1">

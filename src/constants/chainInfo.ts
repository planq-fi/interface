...
import planqCircleLogoUrl from 'assets/svg/planq_logo.svg'
...
import {ARBITRUM_LIST, CELO_LIST, OPTIMISM_LIST, PLANQ_LIST} from './lists'
...
const CHAIN_INFO: ChainInfoMap = {
  ...
  [SupportedChainId.PLANQ]: {
    ...
    infoLink: 'https://info.planq.finance',
    label: 'Planq',
    logoUrl: planqLogo,
    circleLogoUrl: planqCircleLogoUrl,
    nativeCurrency: { name: 'Planq', symbol: 'PLQ', decimals: 18 },
    defaultListUrl: PLANQ_LIST,
  },
